...
import { DemerTemplate } from './components/templates/DemerTemplate';
...
export default function App() {
  ...
  const [selectedTemplate, setSelectedTemplate] = useState<TemplateId>('demer');
  const [isGenerating, setIsGenerating] = useState(false);

  const templates: TemplateId[] = ['demer', 'future', 'cyber', 'creative', 'modern', 'minimal'];
